        ...
        <div class="px-2 my-8 md:px-20">
            <div class="items-center justify-between mb-12 overflow-hidden sm:flex">
                ...
                <div data-aos="fade-left" class="sm:w-[45%] my-2">
                    <h1 style="line-height: 3rem;" class="mb-6 text-3xl font-semibold tracking-wider text-primary sm:text-[2.5rem]">Growth strategies to be effective & competitive</h1>
                    <p class="leading-7">
            ...
            <div data-aos="zoom-in" class="md:flex justify-between my-12 shadow-lg rounded-lg bg-[#EFF1F5] px-4 py-12  md:px-12">
                <div class="md:w-[45%]">
                    <h1 class="mt-3 mb-6 text-3xl font-semibold tracking-wide md:text-5xl text-primary">We'd love to hear from you.</h1>
                    <p class="tracking-wide text-gray-2">
                        With our Service, you're not just getting your work done; you're getting a strategic partner dedicated to driving your business forward through innovation, agility, and exceptional expertise. Contact us today to start the journey toward a software solution that empowers your business to thrive.                    </p>
                </div>
