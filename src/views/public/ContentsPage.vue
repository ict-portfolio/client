<template>
    <div>
        ...
        <div  class="flex-wrap justify-around p-2 sm:flex" v-if="contents.length">
...
import MainPagination from '../../components/base/MainPagination.vue'
    ...
    export default {
        ...
        methods : {
            getContents(page) {
                ApiService.get(`get-contents?page=${page}`).then((res) => {
