<template>
    <div class="relative">
        ...
        <form @submit.prevent="updateService" class="flex flex-wrap justify-around pb-6">
            <div class="w-full">
                <span style="cursor: pointer;margin: auto 0.75rem;" class="material-icons-sharp" @click="$emit('reload')">arrow_back</span>
            </div>
            <div class="w-full">
