<template>
  <div
    class="w-[48%] relative rounded p-3 md:w-[30%] lg:w-[23%] bg-[#ffffff] my-4"
  ...
  <figure>
    ...
    <div class="px-0 pt-2">
      ...
      <p class="my-2 font-sans font-semibold text-primary">
    ...
    <div class="flex justify-end">
      <router-link  :to="{name : 'ProductDetails' , params : {slug : product.slug}}" class="px-3 py-1.5 rounded bg-green text-white font-bold text-sm">show details</router-link>
    </div>
  </div>
</template>
